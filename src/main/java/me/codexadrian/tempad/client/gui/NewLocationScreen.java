...
public class NewLocationScreen extends Screen {
    ...
    protected void init() {
        ...
        Component addLocationText = new TranslatableComponent("gui." + Tempad.MODID + ".add_location");
        EditBox textField = new EditBox(font, cornerX + 16 * 15, cornerY + 16 * 8 - 4, 16 * 8, 24, new TranslatableComponent("gui." + Tempad.MODID + ".textfield"));
