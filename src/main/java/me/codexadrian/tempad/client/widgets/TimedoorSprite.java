...
public class TimedoorSprite implements Widget, GuiEventListener, NarratableEntry {
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
        ...
        RenderSystem.setShaderTexture(0, new ResourceLocation(Tempad.MODID, "textures/widget/timedoor/timedoor_" + age / 4 + ".png"));
    ...
    public void updateNarration(NarrationElementOutput narrationElementOutput) {
        narrationElementOutput.add(NarratedElementType.TITLE, new TranslatableComponent("gui." + Tempad.MODID + ".timedoor"));
    }
}
